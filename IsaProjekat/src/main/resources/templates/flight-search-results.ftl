						...
						<div class="col-md-12 listing-block" style="float: right; border:none !important; border-style:none;">
							<div class="media" ng-repeat="flights in fsCtrl.flightsList | filter: fsCtrl.filterFlights"
                                ...
                                <div style="margin: auto; height:100%" >
                                    <a ng-show="fsCtrl.user != undefined" ui-sref="home-abstract.flight-reservation.interests({direct_id:flights.direct_id, return_id:flights.return_id})" class="btn btn-outlined btn-theme btn-lg d-flex align-self-start"  data-wow-delay="0.7s">Select</a>
                                </div>
