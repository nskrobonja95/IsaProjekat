...
<body>
    ...
    <script src="js/app/controllers/HotelRecommendationResultsController.js"></script>
    <script src="js/app/controllers/AvioAdminWelcomeController.js"> </script>
    <script src="js/app/controllers/HotelStatsController.js"></script>
