                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-3 border-left card-body">
                                            <ul class="list-unstyled">
                                                ...
                                                <li>
                                                    <button id="{{room.id}}" ng-show="globals.currentUser.userType != undefined || hpCtrl.user != null" ng-click="hpCtrl.bookRoom(room)" class="btn btn-primary" style="color:blue;">Book</button>
