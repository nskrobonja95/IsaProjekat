...
<div>
    ...
    <section class="listings">
     ...
     <div class="col-md-9">
                    ...
                    <div class="row mb-3" ng-repeat="hotel in hrsCtrl.searchRes.hotels.hotels">
                                            ...
                                            <div class="list-title">
                                                <ul class="list-inline list-unstyled">
                                                    <li class="list-inline-item">
                                                        <a ui-sref="home-abstract.hotel-profile({hotelId:hotel.id, checkIn:hrsCtrl.searchRes.hotels.checkIn, checkOut:hrsCtrl.searchRes.hotels.checkOut, flightReservations:hrsCtrl.flightResJson})"
                                                         style="color:blue;">
                                                            <h4>{{hotel.name}}</h4>
                                                        </a>
                                                    </li>
